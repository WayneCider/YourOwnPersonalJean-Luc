...
def register_tools(registry):
    """Register all git tools as core YOPJ tools."""
    registry.register_tool("git_status", git_status, "Show git status")
    registry.register_tool("git_diff", git_diff, "Show git diff")
    registry.register_tool("git_log", git_log, "Show recent commits")
    registry.register_tool("git_add", git_add, "Stage files for commit")
    registry.register_tool("git_commit", git_commit, "Create a git commit")
    registry.register_tool("git_branch", git_branch, "List git branches")
